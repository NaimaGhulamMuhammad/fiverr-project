...
import PhoneSignUp from "./pages/sign-up";
        ...
        <Provider value={client}>
          <IonSplitPane contentId="main">
            <IonRouterOutlet id="main">
              ...
              />
              <Route path="/sign-up" exact render={() => <PhoneSignUp />} />
              <Route
              ...
              <Route path="/orders" render={() => <Orders />} />
              <Route path="/order/:id" render={() => <OrderDetailsPage />} />
